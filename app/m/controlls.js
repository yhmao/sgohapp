...
module.exports.verifyGet = function(req,res,next){
...
// get zones
module.exports.zonesGet = function(req,res,next){
...
// create new record
module.exports.recordPatrolNew = function(req,res,next){
...
// get record by id
module.exports.recordPatrolShowOne = function(req,res,next){
...
module.exports.CommentAddText = function(req,res,next){
...
// 添加评论comment
module.exports.commentAdd = function(req,res,next){
...
// remove comment
module.exports.commentRemove = function(req,res,next){
...
module.exports.fileDocRemove = function(req,res,next){
...
module.exports.recordRemove = function(req,res,next){
...
module.exports.filesComment = function(req,res,next) {
  ...
  let comment = new db.Comment({user:user,text:commentContent});
  console.log('comment:', comment);
  db.Record.findById(id,(err,record)=>{
...
module.exports.childrenComment = function(req,res,next) {
  console.log('enter POST m /record_patrol/:id/children/:index/comment/:username');
  ...
  let commentContent = req.body.commentContent;
  let user = req.params.username;
  console.log('id, index, commentContent:', id, index, commentContent);
  let comment = db.FileComment({user:user,text:commentContent});
  console.log('comment:', comment);
  db.Record.findById(id,(err,record)=>{
    if(err) {console.log('err findbyId');return;}
    console.log('record.children[index].children:', record.children[index].children);
    record.children[index].children.push(comment);
    record.markModified('children');
    record.save(()=>{
      res.send(`成功添加评论: ${commentContent}!`)
    });
...
module.exports.bodyText = function(req,res,next){
...
module.exports.bodyFilePlus = function(req,res,next){
...
// 更新图片说明
module.exports.mainFileText = function(req,res,next){
...
*/
module.exports.textSearch =  async function(req,res,next){
...
*/
module.exports.searchPagination = async function(req,res,next){
...
module.exports.searchCoPagination = async function(req,res,next) {
...
//批注
module.exports.typePzAdd = function(req,res,next) {
...
module.exports.fileDocPzRemove = function(req,res,next) {
...
module.exports.commentPzRemove = function(req,res,next) {
...
module.exports.usersResponsible = function(req,res,next) {
