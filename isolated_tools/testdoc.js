...
const {
    ...
    AlignmentType, convertInchesToTwip, Document, HeadingLevel, LevelFormat, Packer, Paragraph, TextRun, UnderlineType
...
Packer.toBuffer(doc).then((buffer) => {
    ...
    console.log("已保存文档 testDoc.docx")
    console.log("试图打开...")

    require('child_process').exec( __dirname + '/testDoc.docx', function (error, stdout, stderr) {
        if (error) {
          console.error(`打开出错: ${error}`);
          return;
        } 
      });
});
